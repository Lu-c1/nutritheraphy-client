//Generated:2021-11-08 07:35:46// 39-516
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5935925 || '',
    GUID: window.ftGUID_5935925 || '99999999999',
    confID: window.ftConfID_5935925 || '0',
    ftReturn: window.ftReturn_5935925 || '',
    keyword: window.ftKeyword_5935925 || '',
    ftId: window.ftId_5935925 || '',
    imp: window.ftImp5935925,
    ftImpId: window.ftImp5935925 && window.ftImp5935925.impID || '',
    gdpr: window.ftImp5935925 && window.ftImp5935925.gdpr || '',
    gdpr_consent: window.ftImp5935925 && window.ftImp5935925.gdpr_consent || '',
    gdpr_pd: window.ftImp5935925 && window.ftImp5935925.gdpr_pd || '',
    us_privacy: window.ftImp5935925 && window.ftImp5935925.us_privacy || '',
    campaignID: '163425',
    cID: '141034',
    pID: '5935925',
    creativeID: '3406139',
    ...
    extscript: [
      "https://ad.doubleclick.net/ddm/trackimpj/N5657.135351SOJERN1/B26504740.314536578;dc_trk_aid=507242607;dc_trk_cid=75437732;ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;gdpr=[%FT_GDPR%];gdpr_consent=[%FT_GDPR_CONSENT%];ltd=?[noCachebuster]"
    ],
    clickTags: [
      "http://servedby.flashtalking.com/click/2/163425;5935925;3406139;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://ad.doubleclick.net/ddm/trackclk/N5657.135351SOJERN1/B26504740.314536578;dc_trk_aid=507242607;dc_trk_cid=75437732;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;ltd="
    ],
    placementDescription: 'MultideviceOverallSOJERNTradingDeskDisplayUnclassifiedRONFormatsstandards160x600FAMILIESActivateMessage4DTITravelIntentES',
    width: 160,
    height: 600,
    ...
    divID: 'ftdiv5935925',
    phID: 'ftpos5935925',
    frameID: 'ftframe5935925',
    expID: 'ftexpframe5935925',
    altImgID: 'ftalt5935925',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/2/163425;5935925;3406139;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://ad.doubleclick.net/ddm/trackclk/N5657.135351SOJERN1/B26504740.314536578;dc_trk_aid=507242607;dc_trk_cid=75437732;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;ltd=',
    altImg: 'http://servedby.flashtalking.com/imp/2/163425;5935925;204;gif;Sojern;MultideviceOverallSOJERNTradingDeskDisplayUnclassifiedRONFormatsstandards160x600FAMILIESActivateMessage4DTITravelIntentES/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/2/163425;5935925;271;pixel;Sojern;MultideviceOverallSOJERNTradingDeskDisplayUnclassifiedRONFormatsstandards160x600FAMILIESActivateMessage4DTITravelIntentES/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/593/5935925/3406139/js/j-5935925-3406139.js',
    file: 'http://cdn.flashtalking.com/141034/3406139/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?215201068-5935925;3406139;',
    adVis: true ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_5935925 || '',
    segmentList: window.ftSegmentList_5935925 || [],
    ftlocal: 'flashtalking/ftlocal.html',
    attachtobody: false,
    zIndex: 77000,
    blockBrowsers: 'ie10,ios8,android4.4'.split(','),
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp5935925 && window.ftImp5935925.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m5935925') && /^https:/.test(document.getElementById('ftscript_m5935925').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5935925'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_5935925'],
      ['ftcfid', 'ftConfID_5935925'],
      ['fttime', 'ftTimestamp_5935925'],
      ['ftsection', 'ftSection_5935925'],
      ['ftcustom', 'ftCustom_5935925'],
      ['ft_id', 'ftId_5935925'],
      ['ftimpid', 'ftImp5935925', 'impID'],
      ['gdpr', 'ftImp5935925', 'gdpr'],
      ['gdpr_consent', 'ftImp5935925', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp5935925', 'gdpr_pd'],
      ['us_privacy', 'ftImp5935925', 'us_privacy']
    ]
  };
...
(function(ft){
    ...
    ft.viewableImpression = "http://servedby.flashtalking.com/imp/2/163425;5935925;202;pixel;Sojern;MultideviceOverallSOJERNTradingDeskDisplayUnclassifiedRONFormatsstandards160x600FAMILIESActivateMessage4DTITravelIntentES/?ft_creative=3406139&ft_configuration=";
    ft.viewableConversion = "true"==="true";
